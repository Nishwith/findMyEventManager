...
class Chennai extends StatefulWidget {
  ...
  @override
  State<Chennai> createState() => _ChennaiState();
}
          ...
          children: [
            Padding(
              ...
              child: ListView.builder(
                  ...
                  itemCount: cevent.length,
                  itemBuilder: (context, index) {
                    final Cevent = cevent[index];
                    return InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => details(user: Cevent),
                        ));
                      },
                      child: Padding(
