          ...
          children: [
            Padding(
              ...
              child: ListView.builder(
                  ...
                  itemCount: devent.length,
                  itemBuilder: (context, index) {
                    final Devent = devent[index];
                    return InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => details(user: Devent),
                        ));
                      },
                      child: Padding(
