          ...
          children: [
            Padding(
              ...
              child: ListView.builder(
                  ...
                  itemCount: mevent.length,
                  itemBuilder: (context, index) {
                    final Mevent = mevent[index];
                    return InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => details(user: Mevent),
                        ));
                      },
                      child: Padding(
