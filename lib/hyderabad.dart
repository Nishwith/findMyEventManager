...
class hyderabad extends StatefulWidget {
  ...
  @override
  State<hyderabad> createState() => _hyderabadState();
}

class _hyderabadState extends State<hyderabad> {
  @override
  List<HEvents> hevents = [
    const HEvents(
        orgName: '1Hyderabad Organisation',
        ...
        address:
            'My Home Jewel - Clubhouse, RTC Colony Rd, Hafeezpet, Madeenaguda, Telangana 500050',
    ...
    const HEvents(
        orgName: '2Hyderabad Organisation',
        urlImg: 'https://nishwith.github.io/interior/CardImg.jpeg',
        details:
            'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',
        address:
        ...
        Simg3:
            'https://focusweddingservices.com//backend-images/gallery_images/278d0220d984edf2bf760a2bede47197ada7d01b.jpeg'),
    const HEvents(
        orgName: '3Hyderabad Organisation',
        urlImg: 'https://nishwith.github.io/interior/CardImg.jpeg',
        details:
            'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',
        address:
        ...
        Simg3:
            'https://focusweddingservices.com//backend-images/gallery_images/278d0220d984edf2bf760a2bede47197ada7d01b.jpeg'),
    const HEvents(
        orgName: '4Hyderabad Organisation',
        urlImg: 'https://nishwith.github.io/interior/CardImg.jpeg',
        details:
            'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',
        address:
        ...
        Simg3:
            'https://focusweddingservices.com//backend-images/gallery_images/278d0220d984edf2bf760a2bede47197ada7d01b.jpeg'),
    const HEvents(
        orgName: '5Hyderabad Organisation',
        urlImg: 'https://nishwith.github.io/interior/CardImg.jpeg',
        details:
            'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',
        address:
        ...
        Simg3:
            'https://focusweddingservices.com//backend-images/gallery_images/278d0220d984edf2bf760a2bede47197ada7d01b.jpeg'),
    const HEvents(
        orgName: '6Hyderabad Organisation',
        urlImg: 'https://nishwith.github.io/interior/CardImg.jpeg',
        details:
            'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',
        address:
        ...
        Simg3:
            'https://focusweddingservices.com//backend-images/gallery_images/278d0220d984edf2bf760a2bede47197ada7d01b.jpeg'),
    const HEvents(
        orgName: '7Hyderabad Organisation',
        urlImg: 'https://nishwith.github.io/interior/CardImg.jpeg',
        details:
            'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.',
        address:
          ...
          children: [
            Padding(
                ...
                child: ListView.builder(
                    ...
                    itemCount: hevents.length,
                    itemBuilder: (context, index) {
                      final user = hevents[index];
                      return InkWell(
                          onTap: () {
